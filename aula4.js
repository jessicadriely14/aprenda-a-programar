...
let semGorjeta = 0
 for (let receita_b of receita){
      if (receita_b.gorjeta == 0.0){
            semGorjeta ++
      }
 }
 console.log(semGorjeta)

 //Exercício 2: Qual o valor total de vendas incluindo a gorjeta?
let somaReceita = 0

 for (let somarValor of receita){
     somaReceita += somarValor.valor + somarValor.gorjeta
 }
console.log(somaReceita)

//Exercício 3: Quantas vendas foram abaixo de 50 reais?

let vendasBaixo_50 = 0

for( let receita_c of receita){
    if(receita_c.valor < 50.0){
        vendasBaixo_50 ++

    }
}

console.log(vendasBaixo_50)
